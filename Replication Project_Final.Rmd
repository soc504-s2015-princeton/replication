...
#pct.upto5 (45 NAs). It appears that something may be wrong with the data on plot size, which would affect the Thiel index and variable regarding plots 5 HA or less.
```

*Potential variable selection issues:* 
