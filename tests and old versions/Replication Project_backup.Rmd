...
<<<<<<< HEAD
            corn.tons = sum(corn.tons), log.corn.yield = log(corn.tons),
  ...
  select(-no.literacy, -indi, -pop.less.2500, -doctors, -fem.house, -total.house, -young.total, -sqkm, -hom.total, -ejidal, -total_area, -comunal, -private, -total_prod_units, -corn.tons, -total.cattle.units) 

##what is this?
# subs_units = sum(subs_units), pct.subs = (subs_units/total_units) * 100
# -subs_units
...
=======
  ...
  mutate(muncode = distrito + 20000)
>>>>>>> badcd9f0799d972d88eb48f09e98ac348996e6f9
...
#write.dbf(map.dbf, "data/maps/Old-Municipios_2010_5.DBF") NOT WORKING
#write.dbf(map.merged, "data/maps/Municipios_2010_5.DBF") NOT WORKING
...
One.c <- glm.nb(hom.rate ~ #PERSONS PER HECTARE + log.corn.yield + log.pop.dens + pct.young + pct.indi + no.lit.rate + pct.fem.house + docs.per.10k + dummy.SOM, data = sample) #we are missing one of the three independent variables in this model: Thiel's land inequality
